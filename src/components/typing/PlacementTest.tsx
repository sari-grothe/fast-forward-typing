...
const i18n: Record<Locale, {
  ...
  en: {
    ...
    huntAndPeckText: "You still find keys with your eyes - your speed comes from short-term memory, not your fingers. That's not a base to build on; it's muscle memory that gets replaced. The good news: with a systematic restart, a few weeks get you further than years of hunting ever did.",
