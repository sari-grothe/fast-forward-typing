...
function buildCategories(locale: Locale): HelpCategory[] {
  ...
  const tools: Record<Locale, HelpItem[]> = {
    de: [
      { question: "Welche kostenlosen Tools gibt es?", answer: "Vier, alle ohne Anmeldung: die Messung deiner Tippgeschwindigkeit (1, 2 oder 5 Minuten), die Einstufung für deinen Trainingsplan, den Vergleich der Tastaturlayouts QWERTZ, QWERTY und AZERTY und 18 Übungstexte zum Abtippen." },
    ...
    en: [
      { question: "Which free tools are there?", answer: "Four, all without sign-up: the typing speed test (1, 2 or 5 minutes), the placement test that builds your training plan, the QWERTY, QWERTZ and AZERTY keyboard layout comparison, and 18 practice paragraphs to type." },
    ...
    fr: [
      { question: "Quels outils gratuits proposez-vous ?", answer: "Quatre, tous sans inscription : le test de dactylographie (1, 2 ou 5 minutes), l'évaluation qui construit ton plan d'entraînement, la comparaison des claviers AZERTY, QWERTY et QWERTZ, et 18 textes d'exercice à taper." },
