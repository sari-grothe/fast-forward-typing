...
const i18n: Record<Locale, {
  ...
  de: {
    ...
    trainingDesc: "15 Min. am Tag, Lektion für Lektion. Am Ende tippst du mit 10 Fingern, ohne auf die Tastatur zu schauen.",
  ...
  en: {
    ...
    trainingDesc: "15 min a day, lesson by lesson. At the end, you'll touch type without looking at the keyboard.",
  ...
  fr: {
    ...
    trainingDesc: "15 min par jour, leçon après leçon. À la fin, tu taperas sans regarder le clavier.",
