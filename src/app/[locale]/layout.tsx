...
export default async function LocaleLayout({ children, params }: Props) {
  ...
  return (
    <html lang={locale}>
      <head>
        <link
          href="https://fonts.googleapis.com/css2?family=JetBrains+Mono:wght@400;500;600;700&family=Poppins:wght@400;500;600;700;800;900&display=swap"
          rel="stylesheet"
        />
        {locales.map((l) => (
          ...
          <nav className="mx-auto max-w-5xl flex items-center justify-between px-4 sm:px-6 py-3">
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              <div className="hidden md:flex items-center gap-4 text-sm font-medium">
                ...
                <a href={`/${locale}/lessons`} className="text-zinc-600 dark:text-zinc-400 hover:text-indigo transition-colors">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-8 mb-8 text-sm">
              ...
              <div>
                ...
                <div className="flex flex-col gap-2 text-zinc-500">
                  ...
                  <a href={`/${locale}/lessons`} className="hover:text-indigo transition-colors">{dict.footer.typingCourse}</a>
