...
const SKIP_HEADINGS = new Set([
  ...
  "Vergleichswerte", "Benchmarks", "Repères", "Mit echten Texten üben", "Practice with real texts", "S'entraîner sur de vrais textes", "Was am Ende drin ist", "What to expect at the end", "Ce qu'on peut viser",
]);
